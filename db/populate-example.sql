INSERT INTO Player VALUES
    (NULL, NULL, 'Mark', 'Ross', NULL, 'mr@email', '5553434', 'Man'),
    (NULL, NULL, 'Marla', 'Pearl', NULL, 'mp@email', '5554534', 'Woman'),
    (NULL, NULL, 'Janice', 'Trill', 'Jan', 'jt@email', '5554522', 'Woman'),
    (NULL, NULL, 'Mike', 'Woo', NULL, NULL, '5556969', 'Man'),
    (NULL, NULL, 'Terry', 'Terrison', NULL, NULL, NULL, 'Man'),
    (NULL, NULL, 'Simón', 'Juarez', NULL, 'sj@email', '5559901', 'Q'),
    (NULL, NULL, 'Tera', 'O\'Dally', NULL, 'to@email', '5551212', NULL),
    (NULL, NULL, 'Parker', 'Pug', NULL, 'pp@email', '5555867', 'Woman'),
    (NULL, NULL, 'Summer', 'Summerson', NULL, 'ss@email', '5559382', 'Woman'),
    (NULL, NULL, 'Tyra', 'Blanks', NULL, 'tb@email', '5558888', 'Man'),
    (NULL, NULL, 'Scott', 'Diamante', NULL, 'sd@email', '5558483', 'Man'),
    (NULL, NULL, 'Chet', 'Debon', 'Cherry Chet', 'cd@email', '5558181', 'T'),
    (NULL, NULL, 'Harry', 'Topper', 'Hip Harry', 'ht@email', '5553333', 'Man'),
    (NULL, NULL, 'Gretta', 'Niehls', NULL, 'gn@email', '5553933', 'Woman'),
    (NULL, NULL, 'Maybe', 'Bluth', NULL, NULL, NULL, 'Woman'),
    (NULL, NULL, 'Blaze', 'Tender', NULL, NULL, NULL, 'Man'),
    (NULL, NULL, 'Sharon', 'Lee', 'Sharon Baron', NULL, NULL, 'Woman'),
    (NULL, NULL, 'Wanda', 'Psyches', NULL, NULL, NULL, 'Woman'),
    (NULL, NULL, 'Mario', 'Mario', NULL, NULL, NULL, 'Man'),
    (NULL, NULL, 'Peach', 'Nontando', NULL, NULL, NULL, 'Woman')
    ;
